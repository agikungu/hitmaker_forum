...
?>
  ...
  <center>
<h1 style="font-family:stencil">Manage Users</h1>  
</center>
...
<tr>
  ...
  $srno=0;
   ...
   <td><?php  echo  $srno;   ?></td>
                ...
                <td>
                <a href="userbio.php?id=<?php echo $mainid; ?>"class="btn btn-info"><i class="fas fa-eye"></i></span> </a> 
  &nbsp;&nbsp;
                <?php 
                $suparadmin="kaggz";
                  if ($username!=$suparadmin) {  ?>
                <a href="deleteadmin.php?id=<?php echo $mainid; ?>"class="btn btn-danger">
